...
def ProcessScan():
    ...
    for proc in psutil.process_iter():
        try:
            ...
            info["open_filesCount"] = len(open_files)   
            info["Ram_Usage"] = proc.memory_info().rss/(1024 * 1024)
...
def SendMail(sender, app_password,receiver,subject,body):
    global log_file_path
...
def main():
    ...
    # python Demo.py 5 Marvellous
        ...
        receiver_email = "laxmishinde2975@gmail.com"

        subject = "Test mail from python script"

        body = "Cheaking File send mail"

        schedule.every(int(sys.argv[1])).minutes.do(SendMail,sender_email, app_password,receiver_email,subject,body)
