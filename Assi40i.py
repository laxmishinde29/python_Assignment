...
print("Predicted result of training:")
print(y_train_pred)


y_test_pred = model.predict(x_test)
print("Predicted result of testing:")
print(y_test_pred)
...
print("Training Accuracy of model:",Accuracy_train*100)


Accuracy_test = accuracy_score(y_test,y_test_pred)
print("Testing Accuracy of model:",Accuracy_test*100)
