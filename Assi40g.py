...
#Random State = 0, Accuracy of model: 83.33333333333334
#Random State = 10, Accuracy of model: 83.33333333333334
#Random State = 42, Accuracy of model: 100.0

#The result will changes